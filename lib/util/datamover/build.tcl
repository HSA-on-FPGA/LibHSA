...
# create project
set proj_obj [create_project "datamover" "$script_dir/build"]
...
# xilinx datamover bd file
source "xilinx_datamover.tcl"

# files
source "files.tcl"

# set toplevel entity
set_property "top" "datamover" [get_filesets sources_1]
