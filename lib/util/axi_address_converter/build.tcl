...
# create project
set proj_obj [create_project "axi_address_converter" "$script_dir/build"]
...
add_files "axi_address_converter.vhd"

# set toplevel entity
set_property "top" "axi_address_converter" [get_filesets sources_1]
