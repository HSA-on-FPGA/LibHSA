...
set_property description         {HSA Packet Processor}   [ipx::current_core]
...
set_property name {packet_processor} [ipx::current_core]
set_property display_name {Packet Processor} [ipx::current_core]

#ipx::infer_bus_interface rcv_acc_irq_lanes xilinx.com:signal:interrupt_rtl:1.0 [ipx::current_core]
ipx::infer_bus_interface snd_acc_irq_lanes xilinx.com:signal:interrupt_rtl:1.0 [ipx::current_core]
ipx::infer_bus_interface rcv_aql_irq_ack xilinx.com:signal:interrupt_rtl:1.0 [ipx::current_core]
...
ipx::infer_bus_interface rcv_acc_irq_lanes_ack xilinx.com:signal:interrupt_rtl:1.0 [ipx::current_core]
...
#ipx::infer_bus_interface snd_acc_irq_lanes_ack xilinx.com:signal:interrupt_rtl:1.0 [ipx::current_core]
