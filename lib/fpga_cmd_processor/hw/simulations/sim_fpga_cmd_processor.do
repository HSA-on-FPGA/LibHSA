...
set hsarepo "../../../.."
set mips64dir "$hsarepo/lib/ext/mips64"
set fcpdir "$hsarepo/fpga_cmd_processor/hw"
set commondir "$hsarepo/lib/common"
set software "$hsarepo/fpga_cmd_processor/sw"
set core_software "$software/core/vsim"
...
vcom -reportprogress 300 -work work $fcpdir/memory_controller/external_memory_interface_fcp.vhd
...
vcom -reportprogress 300 -work work $fcpdir/memory_controller/memory_controller_fcp.vhd

# top sources
vcom -reportprogress 300 -work work $commondir/interrupts/interrupt_demux.vhd
vcom -reportprogress 300 -work work $fcpdir/fpga_cmd_processor_top.vhd
...
vcom -reportprogress 300 -work work $fcpdir/tb_fpga_cmd_processor_top.vhd

# start simulation

vsim -t 1ps -novopt -GG_MEM_NUM_4K_DATA_MEMS=$DATA_MEM_BLOCKS -GG_MEM_NUM_4K_INSTR_MEMS=$INSTR_MEM_BLOCKS -GG_NUM_ACCELERATOR_CORES=$ACCELERATOR_CORES work.tb_fpga_cmd_processor_top
view wave

# load dram
mem load -filltype value -filldata 0 -fillradix hexadecimal -skip 0 /tb_fpga_cmd_processor_top/inst_dram/bram

# initialize config
mem load -filltype value -filldata 0 -fillradix hexadecimal -skip 0 /tb_fpga_cmd_processor_top/inst_config/bram

config wave -signalnamewidth 1

add wave -noupdate -divider -height 32 testbench
add wave -radix hex sim:/tb_fpga_cmd_processor_top/*
#*/

add wave -noupdate -divider -height 32 fpga_cmd_processor_internal
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/*
#*/

add wave -noupdate -divider -height 32 mem_ctrl
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/inst_memory_controller/*
#*/

add wave -noupdate -divider -height 32 external_mem
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/inst_memory_controller/external_memory_interface_inst/*
#*/

add wave -noupdate -divider -height 32 irq_ctrl
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/inst_interrupt_demux/*
#*/

add wave -noupdate -divider -height 32 mem_router
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/inst_memory_controller/mem_router_inst/*
#*/

add wave -noupdate -divider -height 32 mem_router_data_mem_axi
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/inst_memory_controller/mem_router_inst/dmem_bram_inst/*
#*/

add wave -noupdate -divider -height 32 cpu_top
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/*
#*/

add wave -noupdate -divider -height 32 stage_PC
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_stage_pc/*
#*/

add wave -noupdate -divider -height 32 INSTRUCTION_FETCH
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_fetch/*
#*/

add wave -noupdate -divider -height 32 stage_IF_ID
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_stage_if_id/*
#*/

add wave -noupdate -divider -height 32 INSTRUCTION_DECODE
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/*
#*/

add wave -noupdate -divider -height 32 BRANCHING_UNIT
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/branching_unit_inst/*
#*/

add wave -noupdate -divider -height 32 DECODER_UNIT
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/decoder_unit_inst/*
#*/

add wave -noupdate -divider -height 32 ASIP_DECODE
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/decoder_unit_inst/asip_decode_inst/*
#*/

add wave -noupdate -divider -height 32 FORWARDING_UNIT
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/forwarding_unit_inst/*
#*/

add wave -noupdate -divider -height 32 HAZARD_DETECTION_UNIT
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_instruction_decode/hazard_detection_unit_inst/*
#*/

add wave -noupdate -divider -height 32 stage_ID_EX
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_stage_id_ex/*
#*/

add wave -noupdate -divider -height 32 EXECUTE
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_execute/*
#*/

add wave -noupdate -divider -height 32 ASIP_ALU
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_execute/asip_alu_inst/*
#*/

add wave -noupdate -divider -height 32 stage_EX_MEM
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_stage_ex_mem/*
#*/

add wave -noupdate -divider -height 32 MEMORY_ACCESS
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_memory_access/*
#*/

add wave -noupdate -divider -height 32 stage_MEM_WB
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_stage_mem_wb/*
#*/

add wave -noupdate -divider -height 32 WRITE_BACK
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_write_back/*
#*/

add wave -noupdate -divider -height 32 COPROCESSOR
add wave -radix hex sim:/tb_fpga_cmd_processor_top/uut/cpu_top_inst/inst_coprocessor0/*
#*/

add wave -noupdate -divider -height 32 simulation_dram
add wave -radix hex sim:/tb_fpga_cmd_processor_top/inst_dram/*
#*/

add wave -noupdate -divider -height 32 simulation_config
add wave -radix hex sim:/tb_fpga_cmd_processor_top/inst_config/*
#*/

run 2 ms

# store configuration bram memory to file
mem save -format mti -dataradix hex -wordsperline 2 -outfile config_out.mem /tb_fpga_cmd_processor_top/inst_config/bram

# store dram (simulation bram memory) to file
mem save -format mti -dataradix hex -wordsperline 2 -outfile dram_out.mem /tb_fpga_cmd_processor_top/inst_dram/bram
